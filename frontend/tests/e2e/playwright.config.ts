 ...
 *
 * RUNNING TESTS:
 * - Default (all tests): npx playwright test
 * - Integration only: npx playwright test -c tests/e2e/integration/playwright.config.ts
 * - With UI: npx playwright test --ui
 *
 * REQUIREMENTS:
 * - For integration tests: Frontend at localhost:5173, Backend at localhost:8080
 * - For default tests: Just Frontend at localhost:5173 (uses webServer)
 */
