...
test.describe('Auth API Tests', () => {
  test('03 — Authenticated user can access /api/alerts', async ({ authenticatedPage }) => {
  ...
  test('04 — Authenticated user can access /api/notifications', async ({ authenticatedPage }) => {
