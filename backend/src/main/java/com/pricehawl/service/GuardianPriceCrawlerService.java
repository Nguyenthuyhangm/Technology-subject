...
@Service
public class GuardianPriceCrawlerService {
    ...
    @Value("${pricehawk.crawler.guardian-refresh-script}")
    private String guardianRefreshScriptPath;

    @Value("${pricehawk.crawler.timeout-seconds:90}")
    private long timeoutSeconds;

    public GuardianPriceCrawlerService(ObjectMapper objectMapper) {
    ...
    public PriceSnapshotDTO crawlPriceSnapshot(String productUrl) {
        ...
        try {
            ProcessBuilder pb = new ProcessBuilder(
                    nodeBinary,
                    "tsx",
                    guardianRefreshScriptPath,
                    productUrl
            );

            pb.redirectErrorStream(false);

            System.out.println("========== GUARDIAN CRAWLER DEBUG ==========");
            System.out.println("nodeBinary = " + nodeBinary);
            System.out.println("scriptPath = " + guardianRefreshScriptPath);
            ...
            System.out.println("========== GUARDIAN CRAWLER RESULT ==========");
