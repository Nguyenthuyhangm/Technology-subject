...
@Service
public class HasakiPriceCrawlerService {
    ...
    @Value("${pricehawk.crawler.hasaki-refresh-script}")
    private String hasakiRefreshScriptPath;

    @Value("${pricehawk.crawler.timeout-seconds:90}")
    private long timeoutSeconds;

    public HasakiPriceCrawlerService(ObjectMapper objectMapper) {
    ...
    public PriceSnapshotDTO crawlPriceSnapshot(String productUrl) {
        ...
        try {
            ProcessBuilder pb = new ProcessBuilder(
                    nodeBinary,
                    "tsx",
                    hasakiRefreshScriptPath,
                    productUrl
            );

            pb.redirectErrorStream(false);

            System.out.println("========== HASAKI CRAWLER DEBUG ==========");
            System.out.println("nodeBinary = " + nodeBinary);
            System.out.println("scriptPath = " + hasakiRefreshScriptPath);
            ...
            System.out.println("========== HASAKI CRAWLER RESULT ==========");
